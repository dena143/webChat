...
export const paginateMessages = (id, page) => (dispatch) => {
  return ChatService.paginateMessages(id, page)
    .then(({ result: { messages, pagination } }) => {
